...
<template>
  <div class="box">
    ...
    <div class="search">
      ...
      <div class="bottom">
        <button class="button1" @click="add">新增一体机</button>
      ...
      <div class="content">
        <div class="content_top">
          ...
          <div class="content_btn">
            ...
            <Button class="content_btns" @click="module_back">返回</Button>
          </div>
        </div>
      ...
      columns: [
        ...
        },
        {
          ...
          render: (h, params) => {
            ...
            let state = params.row.cameraType;
            return h(
              "label",
              {
                // style: {
        ...
        },
        {
          ...
          render: (h, params) => {
            // console.log(params);
            let clist = params.row.edificeName;
            const list = [];
            let sindex = 0;
            if (clist && clist !== null) {
              // console.log(clist);
        ...
        },
        {
          ...
          minWidth: 80,
          render: (h, params) => {
            console.log(params.row.cameraOnlineStatus);
            let state = params.row.cameraOnlineStatus;
            return h(
              "label",
              {
                style: {
  ...
  methods: {
    ...
    sear1() {
      ...
      if (this.modal_onename) {
        this.condition1.condition.cameraCode = this.modal_onename;
      } else {
        this.condition1.condition.cameraCode = null;
      }
    ...
    sear() {
      ...
      if (this.carname) {
        ...
        this.condition.condition.parkCode = null;
      }
      if (this.inout) {
        this.condition.condition.cameraType = this.inout;
      } else {
        this.condition.condition.cameraType = 0;
      }
      if (this.onename) {
        this.condition.condition.cameraCode = this.onename;
      } else {
        this.condition.condition.cameraCode = null;
      }
      if (this.search_state != null) {
        this.condition.condition.cameraOnlineStatus = this.search_state;
      } else {
        this.condition.condition.cameraOnlineStatus = null;
      }
      if (this.cameraSim) {
        this.condition.condition.cameraSim = this.cameraSim;
      } else {
        this.condition.condition.cameraSim = "";
      }
      console.log(this.cameraSim);
        ...
        .then((res) => {
          ...
          if (res.data.data.list.length == 0) {
            ...
            let datas = res.data.data.list.map((res) => {
              ...
              res.cameraOnlineStatus =
                res.cameraOnlineStatus == 0
                  ? "离线"
                  : res.cameraOnlineStatus == 1
                  ? "在线"
                  : "";
