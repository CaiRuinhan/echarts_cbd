let Url = {
  ...
  // excel: 'https://api.linkmoreparking.net'
    //车场下拉框
  park_list:'echarts/analysis/datav/list',
  //统计区间共有多少辆车
  cars_num:'echarts/analysis/history/datav/list',
  //车位紧缺分析
  cars_lack:'echarts/analysis/history/datav/list/lack',
  //车位使用率分析
  cars_rate:'echarts/analysis/park/history/datav/list/rate',
  //车位流量分析
  cars_flow:'echarts/analysis/park/history/datav/list/flow/all',
  //全年车流热力值
  year_number:'echarts/analysis/history/datav/list',
